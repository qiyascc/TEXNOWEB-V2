    ...
    <div class="row mt-4">
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card p-3 rounded-3 max-height-for-news-item">
                <img src="../images/news/saf.png" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card p-3 rounded-3 max-height-for-news-item">
            <img src="../images/news/battlebots.png" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card p-3 rounded-3 max-height-for-news-item">
            <img src="../images/news/texnoparkCom.png" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card p-3 rounded-3 max-height-for-news-item">
            <img src="../images/news/wcuapp.jpg" class="card-img-top" alt="...">
                <div class="card-body">
