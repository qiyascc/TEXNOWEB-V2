            ...
            <div class="row flex-column-reverse flex-lg-row mt-5">
                <div class="col-lg-6">
                    <div class="list-group" id="projectList">
                        <a href="#" class="list-group-item list-group-item-action p-16 active-border" data-bs-toggle="list" onclick="showProject('../images/mainPageImages/projects/texnoRobot.jpg', '##', this)">
