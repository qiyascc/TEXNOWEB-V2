            ...
            <div class="row flex-column-reverse flex-lg-row mt-5">
                <div class="col-lg-6">
                    <div class="list-group" id="projectList">
                        <a href="#" class="list-group-item list-group-item-action p-16" data-bs-toggle="list" onclick="showProject('../images/projects/texnoRobot.jpg', 'link1.html', this)">
                        ...
                        <a href="#" class="list-group-item list-group-item-action p-16" data-bs-toggle="list" onclick="showProject('../images/projects/biogas.jpg', '##', this)">
                            <div class="d-flex w-100">
                        ...
                        <a href="#" class="list-group-item list-group-item-action p-16" data-bs-toggle="list" onclick="showProject('../images/projects/pianoStairs.png', '##', this)">
                            <div class="d-flex w-100">
                        ...
                        <a href="#" class="list-group-item list-group-item-action p-16" data-bs-toggle="list" onclick="showProject('../images/projects/lightStairs.jpg', '##', this)">
                            <div class="d-flex w-100">
                                <i class="texno-hard-icon texno-icon"></i>
