    ...
    <div class="marquee-container contestlist">
        <div class="marquee">
            <div class="marquee__group d-flex align-items-center justify-content-around">
                <img src="../images/contests/abb.png" alt="Logo 1">
                <img src="../images/contests/saf.png" alt="Logo 2">
                <img src="../images/contests/spaceapps.png" alt="Logo 3">
                <img src="../images/contests/Vector.png" alt="Logo 4">
                <img src="../images/contests/teknofest.png" alt="Logo 5">
                <img src="../images/contests/ca.png" alt="Logo 6">
            </div>
        </div>
    </div>
</div>
